            ...
            if (parsedMessage != null) {
                try {
                    ...
                    if (LOG.isTraceEnabled()) {
                        LOG.trace("Consumer: Failed to write message " + parsedMessage, e);
                    }
                    throw new RuntimeException("Consumer: Failed to write message " + parsedMessage.toTruncatedString(), e);
                }
                if (mDeterministicUploadPolicyTracker != null) {
