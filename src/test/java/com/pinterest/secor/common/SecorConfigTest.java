...
public class SecorConfigTest {
    ...
    private static PropertiesConfiguration loadConfiguration(URL configFile) throws ConfigurationException {
        PropertiesConfiguration properties = new PropertiesConfiguration();
        properties.setListDelimiterHandler(new LegacyListDelimiterHandler(','));
        new FileHandler(properties).load(configFile);
        return properties;
    }
    ...
    public void config_should_read_migration_required_properties_default_values() throws ConfigurationException {
        ...
        PropertiesConfiguration properties = loadConfiguration(configFile);
